...
public class DoctorService
    ...
    public Doctor update(String uuid, DoctorUpdateDTO doctorUpdateDTO) {
        ...
        if (doctorUpdateDTO.getFirstname() != null)
            doctor.getUser().setFirstName(doctorUpdateDTO.getFirstname());

        if (doctorUpdateDTO.getLastname() != null)
            doctor.getUser().setLastName(doctorUpdateDTO.getLastname());

        if (doctorUpdateDTO.getPhone() != null)
            doctor.getUser().setPhone(doctorUpdateDTO.getPhone());
