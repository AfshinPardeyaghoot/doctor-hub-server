...
public class DoctorService
    ...
    public void seeder() throws Exception {
        if (doctorRepository.count() == 0) {
            ...
            Doctor doctor4 = createDoctor("مبینا", "خوشبخت", String.format("0912%s", randomUtil.generateRandomNumber(7)), "child_specialist", "w2.jpg", " متخصص کودکان و نوزادان فارغ التحصیل ازدانشگاه علوم پزشکی شهید بهشتی 24 سال سابقه طبابت رشد و تکامل نوزاد شیردهی نوزاد و زردی نوزادی درمان بیماری های کودکان غدد ،عفونی ، آلرژی ،اعصاب و... ");
            ...
            Doctor doctor7 = createDoctor("محدثه", "نجفی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "ophthalmology_expert", "w4.jpg", "جراح و متخصص بیماری های چشم فارغ التحصیل از دانشگاه علوم پزشکی شیراز");
            Doctor doctor8 = createDoctor("حمید", "لشکری", String.format("0912%s", randomUtil.generateRandomNumber(7)), "optometry_expert", "m5.jpg", " فارغ التحصیل پزشکی عمومی از وانشگاه علوم پزشکی تهران رزیدنت چشم پزشکی دانشگاه علوم پزشکی ایران");
            Doctor doctor9 = createDoctor("سمیرا", "یاقوت", String.format("0912%s", randomUtil.generateRandomNumber(7)), "ophthalmology_expert_assistant", "w5.jpg", "جراح و متخصص چشم پزشکی (رزیدنت سال سوم) انجام جراحی های : آب مروارید , بلفاروپلاستی ,مجاری اشکی ,برداشتن عینک , افتادگی پلک , تزریقات داخل چشمی , انحراف چشم , ناخنک و خال ملتحمه درمان بیماریهای چشمی اعم از :عفونت ها , التهاب های داخل چشمی , اشک ریزش , آب سیاه , تنبلی چشم , تروما های چشمی , اختلالات پلکی , تجویز عینک , مشکلات چشمی بیماران دیابتی , قوز قرنیه و سایر اورژانس های چشم پزشکی ");
            ...
            Doctor doctor10 = createDoctor("اکیر", "فهمیده", String.format("0912%s", randomUtil.generateRandomNumber(7)), "general", "m6.jpg", " دارای مدرک پزشکی از دانشگاه دولتی و با 24 سال سابقه طبابت در زمینه داخلی، اطفال، اعصاب و سابقه 8 ساله درمان اعتیاد مواد مخدر و شیشه در...");
            ...
            Doctor doctor11 = createDoctor("الهام", "رزمجوی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "otorhinolaryngology_expert", "w6.jpg", "متخصص گوش وحلق وبینی مسایل مربوط به پزشکی قانونی با سابقه کاری در ان حوزه");
            Doctor doctor12 = createDoctor("غلام حسین", "شمس", String.format("0912%s", randomUtil.generateRandomNumber(7)), "otorhinolaryngology_expert_assistant", "m7.jpg", "31898 فارغ التحصیل از دانشگاه علوم پزشکی اهواز دارای بیش از سی سال سابقه فعالیت متخصص گوش و حلق و بینی انجام اعمال جراحی سروگردن و زیبایی بینی با تعرفه دولتی مشاوره رایگان ");
            ...
            Doctor doctor13 = createDoctor("سمیه", "بهرامی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "cardiovascular_expert", "w7.jpg", "150674 فارغ التحصیل دوره پزشکی عمومی و تخصص قلب و عروق از دانشگاه علوم پزشکی شهید بهشتی شهر تهران دارای مدرک زبان رشته پزشکی (MCHE)، دارای بورد تخصصی در رشته قلب و عروق شرکت در چندین کنگره علمی داخلی و خارجی");
            Doctor doctor14 = createDoctor("مجید", "سعیدی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "cardiovascular_specialist", "m8.jpg", " هیأت علمی دانشگاه علوم پزشکی شهید بهشتی. سابقه تالیف و ترجمه کتب متعدد در شاخه تخصصی کودکان و فوق تخصصی قلب کودکان. دارنده چندین مقاله علمی در مجلات داخلی و خارجی.");
            Doctor doctor15 = createDoctor("محمد علی", "موسوی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "cardiovascular_expert_assistant", "m9.jpg", "سابقه 5 سال فعالیت مستمر در اورژانس های جنرال به عنوان پزشک اورژانس دوره های اورژانس-داخلی-اطفال رزیدنت تخصصی بیماریهای قلب و عروق ");
            ...
            Doctor doctor26 = createDoctor("نیما", "رضازاده", String.format("0912%s", randomUtil.generateRandomNumber(7)), "plastic_surgery_specialist", "m18.jpg", "رزیدنت سال اخر جراحی عمومی دانشگاه علوم پزشکی همدان بیمارستان فوق تخصصی بعثت حیطه تخصصی در زمینه: تروما،جراحی های داخل شکم به روش باز یا لاپاراسکوپیک،واریس و جراحی های عروقی،بیماری و جراحی های پستان،جراحی های پلاستیک (لیپوماتیک،ماموپلاستی،بلفاروپلاستی،تزریق بوتاکس و فیلر و لیفتینگ )");
            Doctor doctor27 = createDoctor("عرفان", "داننده", String.format("0912%s", randomUtil.generateRandomNumber(7)), "plastic_surgery_expert_assistant", "m16.jpg", " فوق تخصص جراحی پلاستیک و ترمیمی ▪️جراحی زیبایی بینی «رینوپلاستی» ▪️جراحی زیبایی سینه «ماموپلاستی و لیفت» ▪️جراحی زیبایی شکم «ابدومینوپلاستی» ▪️جراحی زیبایی پلک و ابرو «بلفاروپلاستی» ▪️جراحی زیبایی صورت «لیفت» ▪️تزریق فیلر و چربی جهت فرم دهی و زاویه سازی ▪️بوتاکس ▪️لیزر");
            Doctor doctor28 = createDoctor("شروین", "قمیشی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "plastic_surgery_fellowship", "m19.jpg", "بورد تخصصی جراحی عمومی دستیار فوق تخصصی جراحی پلاستیک و ترمیمی رتبه اول آزمون فوق تخصص جراحی پلاستیک و ترمیمی");
            ...
            Doctor doctor29 = createDoctor("سعید", "ریگی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "dermatologist_expert_assistant", "m17.jpg", "دستیار تخصصی بیماری های پوست،مو،ناخن،مخاط دهان. ارائه مشاوره در زمینه زیبایی و جوانسازی ازجمله لیزر و جراحی های زیبایی ");
            Doctor doctor30 = createDoctor("سارا", "هاشمی", String.format("0912%s", randomUtil.generateRandomNumber(7)), "dermatologist_expert", "w14.jpg", "سابقه طبابت در مراکز دولتی و خصوصی در حوزه بیماری های پوست و زیبایی عضو بنیاد ملی نخبگان جوان برتر استانی سال 1397 دانش آموخته دانشگاه علوم پزشکی ایران مدرس و مولف پزشکی");
    ...
    public Doctor createDoctor(String firstName, String lastName, String phone, String specialityName, String profileImageName, String description) throws Exception {
