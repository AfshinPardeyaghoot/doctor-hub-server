...
public class CategoryService
    ...
    public void seeder() throws Exception {
        ...
        createIfNotExist("general_surgeon", "جراحی عمومی", "مشاوره با متخصص جراحی", "مراقبت ها و جراحی هایی مثل فتق، دستگاه گوارش", storageFileService.create(new ClassPathResource("static/icon/jarahi.png").getInputStream(), StorageFileType.CATEGORY_IMAGE, "surgery"));
        ...
        createIfNotExist("dermatologist", "پوست و مو", "مشاوره با متخصص سلامت پوست و مو", "جوش، خارش و عفونت پوست،ریزش مو ، شوره سز", storageFileService.create(new ClassPathResource("static/icon/post-and-mo.png").getInputStream(), StorageFileType.CATEGORY_IMAGE, "dermatologist"));
